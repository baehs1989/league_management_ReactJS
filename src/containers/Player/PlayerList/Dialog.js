  ...
  return (
    <div>
      <Dialog open={props.dialog} onClose={props.handleDialogClose} TransitionComponent={Transition}>
        ...
        <PlayerForm teams={props.teams} updating={props.updating} selectedPlayer={props.selectedPlayer} handleSubmit={props.handleSubmit} selectedTeam={props.selectedTeam}/>
      </Dialog>
    </div>
  );
}
